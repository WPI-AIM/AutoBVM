 ...
 * Adjustable values
 */
AdjustableValue adjustable_values[AdjValueType::ADJ_VALUE_COUNT];       // JOSH PRESSURE
...
const AdjValueParams adj_value_settings[] = {
        ...
        {"Pressure",         "",           "%.2f", "%.2f", "cmH2O", PRESSURE_MIN,   PRESSURE_MAX, PRESSURE_MIN,   0.1, palette_color_1}, // JOSH PRESSURE

};

/*********************************************** HOW ADJUSTABLE VALUES AFFECT THE STEPPER MOTOR (INFO TO USE FOR WIPER IMPLEMENTATION) ***********************************************
 * Tidal Volume: WIPER MOTOR SPEED CANNOT CHANGE AND NO POSITION CONTROL, TIDAL VOLUME CANNOT WORK WITH IT(?)
 * Resp Rate: Increase makes pedal move at a higher speed, decrease makes pedal move at a lower speed (WORKS WITH WIPER MOTOR)
 * I:E Ratio: Increasing each increases them respectively, decreasing each decreases them respectively (WIPER MOTOR SPEED CANNOT CHANGE, DOES NOT WORK)
 * PEEP: Increasing increases PIP, extrinsic as delivered by ventilator
 * PIP: Highest pressure measured during the respiratory cycle
 * Plateau Time: Affects how long the pedal pauses at the end of inspiration before expiration starts, maybe makes inspiration faster (motor sounded higher-pitched) 
 *               (WORKS WITH WIPER MOTOR JUST ADD A PAUSE TO INTERVAL TIME)
*/
