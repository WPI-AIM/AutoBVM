...
// void open_control_confirm_dialog_motor_switch(lv_event_t* evt, ConfirmChoiceCb confirm_cb, LabelConfigCb label_config_cb = nullptr);
void open_control_confirm_dialog_mode_switch(lv_event_t* evt, ConfirmChoiceCb confirm_cb, LabelConfigCb label_config_cb = nullptr);     // JOSH PRESSURE
