...
//Relay 1 control Pin (SET PIN AS OUTPUT WHEN IMPLEMENTING WIPER MOTOR)
#define RELAY1_CONTROL_PIN 7

//Relay 2 control Pin (SET PIN AS OUTPUT WHEN IMPLEMENTING WIPER MOTOR)
#define RELAY2_CONTROL_PIN 6
...
// Tidal Volume Chart Config
// #define VOLUME_CHART_MIN_VALUE MIN_BAG_VOL_ML
// #define VOLUME_CHART_MAX_VALUE MAX_BAG_VOL_ML                    // Not sure if even needed for PCV
// #define VOLUME_CHART_MAX_POINTS 100
// #define VOLUME_CHART_REFRESH_TIME 150
// #define VOLUME_CHART_LINE_MODE 1  /**< 0: No dots, only display line. 1: Use dots as data points */
// #define VOLUME_CHART_DOT_SIZE 5   /**< Dot LxW in px. Only applies to LINE_MODE 1 (Default: 5)*/
// #define VOLUME_CHART_LINE_WIDTH 2 /**< Changes the width of the line on the graph (Default: 2)*/

// Enable Wiper Motor (0 Defaults To Stepper Motor)
#define ENABLE_WIPER_MOTOR 0

// Temporary number, used to switch between VCV and PCV modes until button switching works
#define pcv true
